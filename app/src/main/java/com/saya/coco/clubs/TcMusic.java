...
public class TcMusic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tc_music);
        ...
        b2.setOnClickListener(view -> {
            if (cb.isChecked()) {
//                storeNewClubData();
                String club = "Music Club";
                String notificationMessage = "Thank you for joining Music Club";
