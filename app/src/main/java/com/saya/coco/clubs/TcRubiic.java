...
public class TcRubiic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tc_rubiic);
...
//                storeNewClubData();
                String club = "Rubiic Club";
                String notificationMessage = "Thank you for joining Rubiic Club";
                Toast.makeText(this, "Thank you for joining Rubiic Club", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(),MainActivity.class);
