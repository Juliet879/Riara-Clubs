...
import com.saya.coco.events.RedCrossEvents;

public class ViewRedXEvent extends AppCompatActivity {
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_red_xevent);
        ...
        backBtn.setOnClickListener(view -> {
            Intent intent = new Intent(ViewRedXEvent.this, RedCrossEvents.class);
