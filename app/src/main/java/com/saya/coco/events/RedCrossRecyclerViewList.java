...
import com.saya.coco.ViewRedXEvent;
import com.saya.coco.db.EventModel;

import java.util.ArrayList;
import java.util.List;

class RedCrossRecyclerViewList extends RecyclerView.Adapter<RedCrossRecyclerViewList.ViewHolder> {
    ...
    RedCrossRecyclerViewList(Context context, List<EventModel> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.red_cross_list_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.eventCardView.setOnClickListener(view -> {
            Intent intent = new Intent(view.getContext(), ViewRedXEvent.class);
